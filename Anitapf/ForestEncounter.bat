...
echo.
echo Suddenly you hear a monstrous howl, and one of the heinous
echo beasts is upon you!
echo.
pause
...
if /I %gorillahealth% LEQ 0 goto MobDead
echo.
...
if %lootvar% GEQ 3 set breadvar=3
if %lootvar% GEQ 5 set /a flint=%flint% + 1

if %breadvar%==3 set /a bread=%bread% + 3
if %breadvar% NEQ 3 set /a bread=%bread% + 1
